...
protected:
	float speed{0.0f};
	float steeringAngle{0.0f};
	Wheel frontWheels[2] = {Wheel(pos + Position{10, 4, 12.5} / 16), Wheel(pos + Position{-10, 4, 12.5} / 16, true)};
	Wheel backWheels[2] = {Wheel(pos + Position{10, 4, -12.5} / 16), Wheel(pos + Position{-10, 4, -12.5} / 16, true)};
